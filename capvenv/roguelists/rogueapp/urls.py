...
urlpatterns = [
  ...
  path('favorites/add/<int:user_id>/<int:list_id>/', views.add_favorite_list, name='add_favorite_list'),
  path('tags/', views.all_genres, name='all_genres'),
  path('portfolio/', views.portfolio, name='portfolio'),
  path('favorites/remove/<int:user_id>/<int:list_id>/', views.remove_favorite_list, name='remove_favorite_list'),
